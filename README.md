...
## Start here — first time on a new computer
...
1. Download and extract the archive. Keep the extracted `Julia-Time` folder
...
5. Keep the launcher terminal open. It opens the Case Board at
   `http://127.0.0.1:8000/course/index.html` on **your own computer**.

The detailed platform-specific commands and recovery steps are in
[the installation guide](docs/install.md). The bundled visual explanation is
[Start Here](web/course/getting-started.html).
